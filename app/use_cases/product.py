...
class ProductUseCases:
    ...
    def add_product(self, product: Product, category_slug: str):
        ...
        if not category:
            raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail='No category was found with slug')
    ...
    def update_product(self, id: int, product: Product):
        ...
        if product_on_db is None:
            raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail='No product was found')
